...
#define RF2XX_TX_POWER  PHY_POWER_m17dBm // PHY_POWER_m17dBm //ksh.. PHY_POWER_m17dBm // original: PHY_POWER_3dBm
#endif
...
rf2xx_wr_transmit(unsigned short transmit_len)
{
  ...
  ENERGEST_OFF(ENERGEST_TYPE_LISTEN); //ksh..
  ENERGEST_ON(ENERGEST_TYPE_TRANSMIT); //ksh..
  ...
  ENERGEST_OFF(ENERGEST_TYPE_TRANSMIT); //ksh..
...
ENERGEST_ON(ENERGEST_TYPE_CPU);
  ...
  ENERGEST_ON(ENERGEST_TYPE_LISTEN); //ksh..
